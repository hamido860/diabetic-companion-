...
// Solid icons are typically filled. 'fill="currentColor"' and 'stroke="none"' or just 'fill="currentColor"'
// We will remove strokeWidth and stroke props for solid icons where appropriate, or switch to heroicons/solid paths.
...
export const ArrowDownIcon: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={className}>
    <path fillRule="evenodd" d="M12.53 21.53a.75.75 0 01-1.06 0l-7.5-7.5a.75.75 0 111.06-1.06l6.22 6.22V3a.75.75 0 011.5 0v16.19l6.22-6.22a.75.75 0 111.06 1.06l-7.5 7.5z" clipRule="evenodd" />
  </svg>
);
...
export const CameraIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={className}>
        ...
        <path fillRule="evenodd" d="M9.344 3.071a4.988 4.988 0 015.312 0c.217.116.419.264.597.434l.43.43a.75.75 0 00.53.22h5.037A2.25 2.25 0 0123.25 6.379v11.37A2.25 2.25 0 0121 20H3a2.25 2.25 0 01-2.25-2.25V6.38A2.25 2.25 0 013 4.124h5.036a.75.75 0 00.53-.22l.43-.43a4.986 4.986 0 01.598-.434H9.344zM12 18a5.25 5.25 0 100-10.5 5.25 5.25 0 000 10.5z" clipRule="evenodd" />
    </svg>
);
...
export const ArrowUpOnSquareIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={className}>
        <path fillRule="evenodd" d="M11.47 2.47a.75.75 0 011.06 0l4.5 4.5a.75.75 0 01-1.06 1.06l-3.22-3.22V16.5a.75.75 0 01-1.5 0V4.81L8.03 8.03a.75.75 0 01-1.06-1.06l4.5-4.5zM3 15.75a.75.75 0 01.75.75v2.25a.75.75 0 00.75.75h13.5a.75.75 0 00.75-.75V16.5a.75.75 0 011.5 0v2.25a2.25 2.25 0 01-2.25 2.25H4.5a2.25 2.25 0 01-2.25-2.25V16.5a.75.75 0 01.75-.75z" clipRule="evenodd" />
    </svg>
);
...
export const BookOpenIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={className}>
      <path d="M11.25 4.533A9.707 9.707 0 006 3.75a9.706 9.706 0 00-6 2.079V19.5a2.25 2.25 0 002.25 2.25h13.5A2.25 2.25 0 0018 19.5V5.829a9.706 9.706 0 00-6.75-1.296z" />
      <path d="M12.75 4.533A9.706 9.706 0 0118 3.75a9.706 9.706 0 016 2.079V19.5a2.25 2.25 0 01-2.25 2.25H12.75V4.533z" />
    </svg>
);

export const WalkingIcon: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 24 24" fill="currentColor">
    <path d="M13 6a2 2 0 100-4 2 2 0 000 4zM20.14 11.7l-2.64-1.68c-.52-.33-1.17-.26-1.61.15l-3 2.82-1.5-2.25c-.44-.66-1.3-1.14-2.1-1.14H4v2h5.29l2.85 4.28L9.28 22h2.4l1.8-5.21 2.52-2.52 1.7 5.1L22 17.9l-1.86-6.2z" />
  </svg>
);
...
export const ShutterIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 80 80" className={className}>
        ...
        <circle cx="40" cy="40" r="32" fill="currentColor" />
    </svg>
);
...
export const SteakIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 24 24" fill="currentColor">
...
export const WeightScaleIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 24 24" fill="currentColor">
        <path d="M12 2a10 10 0 0 0-10 10 10 10 0 0 0 10 10 10 10 0 0 0 10-10 10 10 0 0 0-10-10zm0 18a8 8 0 1 1 8-8 8.009 8.009 0 0 1-8 8z" />
...
export const ChartScatterIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={className}>
